...
export default function BoxManager(store, isotope) {
	this.store = store;
...
BoxManager.prototype.dispatchOpenBox = function(event) {
	event.preventDefault();
	this.store.dispatch(openBox(`#${event.currentTarget.id}`));
}
BoxManager.prototype.dispatchCloseBox = function(event) {
	event.preventDefault();
	this.store.dispatch(closeBox());
}
BoxManager.prototype.renderOpenBox = function(elem) {
...
BoxManager.prototype.renderCloseBox = function(elem) {
	if(elem === null) { return }
...
BoxManager.prototype.handleBoxStateChange = function() {
...
BoxManager.prototype.onReady = function() {
	// Set up:
