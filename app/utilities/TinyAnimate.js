 ...
 * TinyAnimate.animate()
 */
export const animate = (from, to, duration, update, easing, done) => {
 ...
 */
export const animateCSS = (element, property, unit, from, to, duration, easing, done) => {

    var update = function(value) {
        element.style[property] = value + unit;
    };
    return animate(from, to, duration, update, easing, done);
};
